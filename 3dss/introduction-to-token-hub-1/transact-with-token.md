...
threeDSServerTransID needs to be appended in every request
{% endhint %}

{% swagger method="post" path="" baseUrl="/3dsserverapi/v3/veReq/<merchant-name>/<acquirerID>/<threeDSServerTransID>" summary="pArq Request" %}
{% swagger-description %}
...
```javascript
 {
    ...
    "acsTransID": "202203311212267541tH0uV5dI",
    "merchantTransID": "54c8fefe-e694-3569-7864-d4329ce60971",
    "signatureHashIdentifier": "02",
    "authenticationUrl": "https://<sandbox.com>/3dsserverapi/legacy/fetchAuth/indblr-blrrel/7000/383a4443-28c5-42c1-a87f-85916059359f",
    "merchantCancelChallengeAuthUrl": "https://wibmotest.merchant-wibmo.com/ec945441-9c37-424f-a9b9-00465d61a567",
    "acsChallengeReqUrl": "https://<acssandbox.com/v1/acs/legacy/live/9111/V.D/uid=1c2a039f-44d6-4bab-8a51-52d1tH0uV5dI",
    "acsChallengeReqFormData": {
        "md": "54c8fefe-e694-3569-7864-d4329ce60971",
        "paReq": "",
        "termUrl": "https://merchantsecure.com/fetchAuthResponse"
    }
}
...
```
curl --location --request POST 'https://<sandbox.com>/3dsserverapi/v3/veReq/indblr-blrrel/7000/383a4443-28c5-42c1-a87f-85916059359f' \
...
--data-raw '{
    ...
    "messageVersion": "1.0.2",
    "messageCategory": "01",
    "sdkAppID": "34c8fefe-f694-4569-9869-c4029ce60971",
    "sdkEphemPubKey": {
        "kty": "EC",
        "crv": "P-256",
        "x": "EsqgE0MyAglDuLob00wq5iBGX2UnOz_HNsrHFm0EB9w",
        "y": "7rdJPswjssPktbzHH9QjjAyXQyxulR-X4cR0q10Ns_g"
    },
    "sdkTransID": "5f27d9d4-95c1-4b74-ab41-906859312847",
    "sdkReferenceNumber": "3DS_LOA_SDK_PPFU_020100_00015",
    "sdkMaxTimeout": "05",
    "threeDSCompInd": "U",
    ...
    "threeDSRequestorAuthenticationInfo": {
        ...
        "threeDSReqAuthTimestamp": "201806290644",
