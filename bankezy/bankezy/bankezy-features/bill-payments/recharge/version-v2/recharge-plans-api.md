...
{% swagger method="get" path="/retail-service/plans/v2/list" baseUrl="<domain>" summary="To provide availiable plans for the given operator and circle combination" %}
{% swagger-description %}
...
<table><thead><tr><th width="276">Response Codes</th><th>Response Description</th></tr></thead><tbody><tr><td>RTL200</td><td>Success</td></tr><tr><td>RTL015</td><td>No Plans Available</td></tr></tbody></table>
