...
{% swagger-parameter in="body" name="partnerName2" type="String" required="false" %}
Partner name 2
{% endswagger-parameter %}
...
{% swagger-parameter in="body" name="merchantKycInfo.kycIdNum" type="List<String>" required="true" %}
Kyc Id number
{% endswagger-parameter %}
