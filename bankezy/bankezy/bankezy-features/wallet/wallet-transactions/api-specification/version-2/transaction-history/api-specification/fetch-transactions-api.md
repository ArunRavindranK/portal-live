...
{% swagger method="post" path="" baseUrl="<domain>/txnHistory/fetch/v2" summary="" %}
{% swagger-description %}
...
| Code    | Description                              |
| ------- | ---------------------------------------- |
| ​TXH002 | Request is empty - 400 bad req is coming |
| TXH001  | ​Bank id is empty                        |
| TXH003  | customer id is mandatory                 |

{% tabs %}
{% tab title="Sample curl command" %}
```json
curl --location --request POST '
https://payment1.pcdev.enstage-sas.com/txnHistory/v2/fetch'
