---
description: It will validate the DOB of user.
---

# Validate DOB Of User



{% swagger method="post" path="" baseUrl="<domain>onboarding/userProfile/v2/validateDob" summary="" %}
{% swagger-description %}
...
{% code overflow="wrap" %}
```json
curl --location --request POST 'http://192.168.105.70:8083/onboarding/userProfile/v2/validateDob' \
